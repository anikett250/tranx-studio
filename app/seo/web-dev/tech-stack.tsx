...
const HEADING_WORDS = ["We Use"];

const FEATURES = [
    {
        title: "Frontend",
        desc: "1.Next.js 2.React 3.TypeScript 4.Tailwind CSS 5.Framer Motion",
    },
    {
        title: "Backend",
        desc: "1.Node.js 2.Express.js 3.REST APIs",
    },
    {
        title: "Database",
        desc: "1.MongoDB",
    },
    {
        ...
        desc: "1.Git & GitHub 2.Vercel 3.Netlify 4.Cloudflare",
    },
];
            ...
            <div className="relative w-full h-full overflow-hidden">
                <div className="relative z-10 flex flex-col min-h-screen justify-center px-5 sm:px-6 lg:px-20 py-24">
                    ...
                    <div className="max-w-2xl text-left">
                        ...
                        >
                            We use modern, industry-standard technologies to build websites that are fast, secure, scalable, and easy to maintain.
                        </motion.p>
                    </div>
