...
const HEADING_WORDS = ["Tranx", "Studio"];

const FEATURES = [
    {
        title: "Conversion-Focused Design",
        desc: "Every page is designed to guide visitors toward taking action, whether that's requesting a quote, booking a consultation, or making a purchase.",
    },
    {
        title: "Performance First",
        desc: "Fast-loading websites provide a better user experience, improve search visibility, and reduce visitor drop-offs.",
    },
    {
        title: "Responsive on Every Device",
        desc: "Your website is optimized for desktops, tablets, and smartphones to deliver a seamless experience everywhere.",
    },
    {
        title: "SEO-Ready Foundation",
        desc: "Every website is built with clean code, semantic structure, and technical SEO best practices from the start.",
    },
    {
        title: "Custom Design",
        desc: "We create unique websites tailored to your brand instead of relying on generic templates.",
    },
    {
        title: "Reliable Support",
        desc: "From launch to future updates, we're here to help keep your website running smoothly.",
    },
];
            ...
            <div className="relative w-full h-full overflow-hidden">
                <div className="relative z-10 flex flex-col min-h-screen justify-center px-5 sm:px-6 lg:px-20 py-24">
                    ...
                    <div className="max-w-2xl text-left">
                        ...
                        >
                            We combine strategy, creativity, and modern technology to create websites that don't look exceptional they help your business attract more customers and achieve measurable results.
                        </motion.p>
                    </div>
