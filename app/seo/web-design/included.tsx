...
const HEADING_WORDS = ["Included"];

const FEATURES = [
    {
        title: "Custom Website Design",
        desc: "A unique design tailored to your brand, goals, and audience—never a one-size-fits-all template.",
    },
    {
        title: "Responsive Design",
        desc: "Your website looks and performs flawlessly across desktops, tablets, and smartphones.",
    },
    {
        title: "SEO-Ready Structure",
        desc: "Built with clean code, semantic HTML, and a solid technical SEO foundation to support better search visibility.",
    },
    {
        title: "Conversion-Focused Layouts",
        desc: "Every page is structured to encourage visitors to contact you, request a quote, or take the next step.",
    },
    {
        title: "Security Best Practices",
        desc: "Built with modern security standards to help protect your website and your visitors.",
    },
    {
        title: "Cross-Browser Compatibility",
        desc: "Consistent performance across major browsers, ensuring a reliable experience for every visitor.",
    },
];
            ...
            <div className="relative w-full h-full overflow-hidden">
                <div className="relative z-10 flex flex-col min-h-screen justify-center px-5 sm:px-6 lg:px-20 py-24">
                    ...
                    <div className="max-w-2xl text-left">
                        ...
                        >
                            Every website we build is designed with performance, usability, and long-term growth in mind. Here's what comes with every project.
                        </motion.p>
                    </div>
